...
function populateConstitution(response) {
    ...
    var selectConstitutionOption = document.getElementById("select_constitution");
    if (!selectConstitutionOption) {
        let defaultOption = document.createElement("option");
        defaultOption.innerHTML = "Select Constitution";
        defaultOption.id = "select_constitution"; // Set the id if needed
        constitution.appendChild(defaultOption);
    }
