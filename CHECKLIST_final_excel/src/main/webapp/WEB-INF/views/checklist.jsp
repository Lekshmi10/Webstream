            ...
            <div class="user-control">
                <div class="user-head"><!--open-->
                    ...
                    <div id="signout_div">
                        ...
                        <div id="uname" style="display: none"><% out.print(session.getAttribute("uname"));%></div>
                        <div id="designation" style="display: none"><% out.print(session.getAttribute("designation"));%></div>
                        <div id="department" style="display: none"><% out.print(session.getAttribute("department"));%></div>
