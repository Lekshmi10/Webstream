...
public class CheckListController {
    ...
    public String logChecklistData(@RequestParam  String username,@RequestParam String designation,@RequestParam String department) {
        return logDataService.saveLogData(username,designation,department);
    }
